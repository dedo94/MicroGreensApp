...
/**
 * Bottom sheet "Nuovo vassoio", raggiungibile dal FAB da qualunque tab
 * (hoisted a livello di MicroGreensNavHost, non una destinazione di
 * navigazione: vedi commento su showCreateTraySheet lì).
 */
...
fun TrayCreateSheet(
    ...
    BottomSheetForm(
        title = "Nuovo vassoio",
        onDismiss = onDismiss,
        onConfirm = { viewModel.save(onCreated) },
        confirmLabel = "Crea vassoio",
